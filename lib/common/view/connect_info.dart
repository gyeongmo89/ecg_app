                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          //     await intent.launch();
                          //   }
                          //   print("status.isGranted: ${status.isGranted}"); //여기부터
                          // } else if (status.isGranted) {
                          //   // Permission is granted, proceed with the Bluetooth functionality
                          //   try {
                          //     print("FLAG 1입니다.");
                          //     // Listen for Bluetooth state changes
                          //     FlutterBluePlus.instance.state.listen((BluetoothState state) async {
                          //       if (state == BluetoothState.on) {
                          //         // Bluetooth is turned on, navigate to ScanScreen
